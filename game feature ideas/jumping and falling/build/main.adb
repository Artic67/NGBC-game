M:main
S:Lmain.set_2bpp_palette$palette$1_0$31({2}SI:U),B,1,-2
S:Lmain.set_1bpp_colors$bgcolor$1_0$34({1}SC:U),B,1,-1
S:Lmain.set_1bpp_colors$fgcolor$1_0$34({1}SC:U),B,1,-2
S:Lmain.set_bkg_based_tiles$w$1_0$40({1}SC:U),B,1,2
S:Lmain.set_bkg_based_tiles$h$1_0$40({1}SC:U),B,1,3
S:Lmain.set_bkg_based_tiles$tiles$1_0$40({2}DG,SC:U),B,1,4
S:Lmain.set_bkg_based_tiles$base_tile$1_0$40({1}SC:U),B,1,6
S:Lmain.set_bkg_based_tiles$y$1_0$40({1}SC:U),B,1,-1
S:Lmain.set_bkg_based_tiles$x$1_0$40({1}SC:U),B,1,-2
S:Lmain.set_bkg_based_submap$w$1_0$43({1}SC:U),B,1,2
S:Lmain.set_bkg_based_submap$h$1_0$43({1}SC:U),B,1,3
S:Lmain.set_bkg_based_submap$map$1_0$43({2}DG,SC:U),B,1,4
S:Lmain.set_bkg_based_submap$map_w$1_0$43({1}SC:U),B,1,6
S:Lmain.set_bkg_based_submap$base_tile$1_0$43({1}SC:U),B,1,7
S:Lmain.set_bkg_based_submap$y$1_0$43({1}SC:U),B,1,-1
S:Lmain.set_bkg_based_submap$x$1_0$43({1}SC:U),B,1,-2
S:Lmain.move_bkg$y$1_0$48({1}SC:U),B,1,-1
S:Lmain.move_bkg$x$1_0$48({1}SC:U),B,1,-2
S:Lmain.scroll_bkg$y$1_0$50({1}SC:S),B,1,-1
S:Lmain.scroll_bkg$x$1_0$50({1}SC:S),B,1,-2
S:Lmain.set_win_based_tiles$w$1_0$57({1}SC:U),B,1,2
S:Lmain.set_win_based_tiles$h$1_0$57({1}SC:U),B,1,3
S:Lmain.set_win_based_tiles$tiles$1_0$57({2}DG,SC:U),B,1,4
S:Lmain.set_win_based_tiles$base_tile$1_0$57({1}SC:U),B,1,6
S:Lmain.set_win_based_tiles$y$1_0$57({1}SC:U),B,1,-1
S:Lmain.set_win_based_tiles$x$1_0$57({1}SC:U),B,1,-2
S:Lmain.set_win_based_submap$w$1_0$60({1}SC:U),B,1,2
S:Lmain.set_win_based_submap$h$1_0$60({1}SC:U),B,1,3
S:Lmain.set_win_based_submap$map$1_0$60({2}DG,SC:U),B,1,4
S:Lmain.set_win_based_submap$map_w$1_0$60({1}SC:U),B,1,6
S:Lmain.set_win_based_submap$base_tile$1_0$60({1}SC:U),B,1,7
S:Lmain.set_win_based_submap$y$1_0$60({1}SC:U),B,1,-1
S:Lmain.set_win_based_submap$x$1_0$60({1}SC:U),B,1,-2
S:Lmain.move_win$y$1_0$65({1}SC:U),B,1,-1
S:Lmain.move_win$x$1_0$65({1}SC:U),B,1,-2
S:Lmain.scroll_win$y$1_0$67({1}SC:S),B,1,-1
S:Lmain.scroll_win$x$1_0$67({1}SC:S),B,1,-2
S:Lmain.SET_SHADOW_OAM_ADDRESS$address$1_0$72({2}DG,SV:S),B,1,-2
S:Lmain.set_sprite_tile$tile$1_0$74({1}SC:U),B,1,-1
S:Lmain.set_sprite_tile$nb$1_0$74({1}SC:U),B,1,-2
S:Lmain.get_sprite_tile$nb$1_0$76({1}SC:U),B,1,-1
S:Lmain.set_sprite_prop$prop$1_0$78({1}SC:U),B,1,-1
S:Lmain.set_sprite_prop$nb$1_0$78({1}SC:U),B,1,-2
S:Lmain.get_sprite_prop$nb$1_0$80({1}SC:U),B,1,-1
S:Lmain.move_sprite$y$1_0$82({1}SC:U),B,1,2
S:Lmain.move_sprite$x$1_0$82({1}SC:U),B,1,-1
S:Lmain.move_sprite$nb$1_0$82({1}SC:U),B,1,-2
S:Lmain.move_sprite$itm$1_0$83({2}DG,STOAM_item_t:S),B,1,-4
S:Lmain.scroll_sprite$y$1_0$84({1}SC:S),B,1,2
S:Lmain.scroll_sprite$x$1_0$84({1}SC:S),B,1,-1
S:Lmain.scroll_sprite$nb$1_0$84({1}SC:U),B,1,-2
S:Lmain.scroll_sprite$itm$1_0$85({2}DG,STOAM_item_t:S),B,1,-4
S:Lmain.hide_sprite$nb$1_0$86({1}SC:U),B,1,-1
S:Lmain.set_native_tile_data$data$1_0$94({2}DG,SC:U),B,1,2
S:Lmain.set_native_tile_data$nb_tiles$1_0$94({1}SC:U),B,1,-1
S:Lmain.set_native_tile_data$first_tile$1_0$94({2}SI:U),B,1,-3
F:G$betterDelay$0_0$0({2}DF,SV:S),C,0,0,0,0,0
S:Lmain.betterDelay$numloops$1_0$0({1}SC:U),R,0,0,[c]
S:Lmain.betterDelay$i$1_0$104({1}SC:U),R,0,0,[b]
F:G$collisionDetect$0_0$0({2}DF,SC:S),C,0,0,0,0,0
S:Lmain.collisionDetect$projectedYpos$1_0$0({1}SC:U),R,0,0,[c]
F:G$jump$0_0$0({2}DF,SV:S),C,0,2,0,0,0
S:Lmain.jump$charStats$1_0$0({2}DG,SC:U),B,1,-3
S:Lmain.jump$characterNum$1_0$0({1}SC:U),B,1,-1
S:Lmain.jump$__1310720006$2_0$114({1}SC:U),R,0,0,[]
S:Lmain.jump$__1310720007$2_0$114({1}SC:U),R,0,0,[c]
S:Lmain.jump$__1310720008$2_0$114({1}SC:U),R,0,0,[b]
S:Lmain.jump$nb$3_0$115({1}SC:U),R,0,0,[]
S:Lmain.jump$x$3_0$115({1}SC:U),R,0,0,[]
S:Lmain.jump$y$3_0$115({1}SC:U),R,0,0,[]
S:Lmain.jump$itm$4_0$116({2}DG,STOAM_item_t:S),R,0,0,[l,h]
S:Lmain.jump$sloc0$0_1$0({1}SC:U),B,1,-4
S:Lmain.jump$sloc1$0_1$0({1}SC:U),B,1,-4
F:G$main$0_0$0({2}DF,SV:S),C,0,0,0,0,0
S:Lmain.main$__1310720010$2_0$123({1}SC:U),R,0,0,[e]
S:Lmain.main$__1310720011$2_0$123({1}SC:U),R,0,0,[]
S:Lmain.main$nb$3_0$124({1}SC:U),R,0,0,[]
S:Lmain.main$tile$3_0$124({1}SC:U),R,0,0,[]
S:Lmain.main$__1310720013$2_0$126({1}SC:U),R,0,0,[e]
S:Lmain.main$__1310720014$2_0$126({1}SC:U),R,0,0,[c]
S:Lmain.main$__1310720015$2_0$126({1}SC:U),R,0,0,[b]
S:Lmain.main$nb$3_0$127({1}SC:U),R,0,0,[]
S:Lmain.main$x$3_0$127({1}SC:U),R,0,0,[]
S:Lmain.main$y$3_0$127({1}SC:U),R,0,0,[]
S:Lmain.main$itm$4_0$128({2}DG,STOAM_item_t:S),R,0,0,[l,h]
S:Lmain.main$__2621440017$4_0$129({1}SC:U),R,0,0,[b]
S:Lmain.main$__2621440018$4_0$129({1}SC:U),B,1,-1
S:Lmain.main$__2621440019$4_0$129({1}SC:U),R,0,0,[c]
S:Lmain.main$nb$5_0$130({1}SC:U),R,0,0,[]
S:Lmain.main$x$5_0$130({1}SC:U),R,0,0,[]
S:Lmain.main$y$5_0$130({1}SC:U),R,0,0,[]
S:Lmain.main$itm$6_0$131({2}DG,STOAM_item_t:S),R,0,0,[e,d]
...
S:G$bg$0_0$0({720}DA720d,SC:U),E,0,0
S:G$Tilemap$0_0$0({128}DA128d,SC:U),E,0,0
S:G$Face$0_0$0({32}DA32d,SC:U),E,0,0
S:G$playerStats$0_0$0({4}DA4d,SC:U),E,0,0
S:G$characterNum$0_0$0({1}SC:U),E,0,0
S:G$jumping$0_0$0({1}SC:U),E,0,0
S:G$acceleration$0_0$0({1}SC:U),E,0,0
S:G$gravity$0_0$0({1}SC:U),E,0,0
S:G$floorYpos$0_0$0({1}SC:U),E,0,0
...
S:G$betterDelay$0_0$0({2}DF,SV:S),C,0,0
S:G$collisionDetect$0_0$0({2}DF,SC:S),C,0,0
S:G$jump$0_0$0({2}DF,SV:S),C,0,2
