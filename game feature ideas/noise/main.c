...
void main() {
    ...
    // with these registers we can use sounds
    NR52_REG = 0x80; // turns on sound
    NR50_REG = 0x77; // sets volume on both chanels to max
    NR51_REG = 0xFF; // select which chanel we will use, in this string both (LEFT and RIGHT)
